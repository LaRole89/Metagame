...
<html>
    ...
    <body>
        ...
        ?>
            ...
            <article>
            <p id="path"> Home > Offerte </p>
            <div id="conteinerCenter">
                <h1>
                Offerte
                </h1>
                <h2>Offerte del giorno</h2><br/>
                    <div class="scheda">
                    ...
                    <div class="scheda">
                        ...
                        <div id="hotlink"><a style="margin-top: 4px;" href="carrello.php"><img src="img/iconacarrello.png" />&nbsp; &nbsp; &nbsp; <img src="img/iconapiu.png" />&nbsp; <img src="img/iconaform.png" /><img src="img/iconameno.png" /></a></div>
                    </div><br/><p style="text-align: left;"> Se sei curioso di vedere le altre nostre offerte <a href="offertadelgiorno.php">clicca qui</a></p><br/>
                <h2>Le nostre offerte</h2><br/>
                     <div class="scheda">
                        <div id="schedaimg"><a href="schedaprodotto.php"><img src="img/giochi/AC4.jpg" /></a></div>
                        <div id="schedadati">
                            <h1>60 euro</h1>
                ...
                <br/><p style="text-align: left;"> Se sei curioso di vedere le altre nostre offerte <a href="lenostreofferte.php">clicca qui</a></p><br/>
            </div>
            </article>
